...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210812_espacoplannar_115894cde79956699481_20210812205232_archive.zip';
	const ARCHIVE_SIZE		 = '78480627';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '115894c-12205232';
    const SECONDARY_PACKAGE_HASH = '4694eed-12205232';
	const VERSION			 = '1.4.2';
